...
call vcpkg install cgltf:x64-android imgui:x64-android vulkan:x64-android vulkan-headers:x64-android ktx[vulkan]:x64-android mimalloc:x64-android sdl2[vulkan]:x64-android sdl2-image:x64-android volk:x64-android vulkan-memory-allocator:x64-android tracy:x64-android
